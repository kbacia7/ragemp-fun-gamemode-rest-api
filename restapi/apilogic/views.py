...
import secrets
from apilogic.serializers import PlayersSpawnsSerializer, TeleportsSerializer, VehiclesSerializer, LevelsSerializer, ObjectsSerializer, PlayersItemsSerializer, ItemsSerializer, ShopTabDataLazySerializer, ShopTabDataSerializer, DerbyArenasSerializer, HideandseekArenasSerializer, RaceArenasSerializer, TdmArenasSerializer, LootboxesSerializer, LootboxItemsSerializer, PlayersSerializer, SettingsSerializer, DmArenasSerializer, HeavyDmArenasSerializer, SniperArenasSerializer, OneShootArenasSerializer
from apilogic.models import Items, PlayersItems, DerbyArenas, ShopEntities, Teleports, Levels, Objects, Vehicles, ShopTabData, Ranks, HideandseekArenas, RaceArenas, TdmArenas, DmArenas, HeavyDmArenas, SniperArenas, OneShootArenas, PlayersSpawns, Players, Settings, Lootboxes, LootboxItems
...
class ObjectsAPI(generics.ListAPIView):    
    def get_queryset(self):
