...
from apilogic.views import EventsAPI, ArenasAPI, PlayersAPI, SettingsAPI, ShopAPI, BuyAPI, LootboxAPI, VehiclesAPI, ObjectsAPI, LevelsAPI, TeleportsAPI
...
urlpatterns = [
    ...
    url(r'^teleports/(?P<action>.+)/$', TeleportsAPI.as_view()),
